 ...
 return (
   <nav className="bg-blue-600 text-white px-5 py-4 flex justify-between items-center shadow-lg">
     ...
     <div className="flex items-center gap-4">
       {/* Task List Button (Hidden on Landing/Login/Signup and for unauthenticated users) */}
       ...
       {/* Profile Button (Hidden on Landing/Login/Signup and for unauthenticated users) */}
       {isAuthenticated && !hideProfileRoutes.includes(location.pathname) && (
